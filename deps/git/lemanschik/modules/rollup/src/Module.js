...
import { augmentCodeLocation, error, errorAmbiguousExternalNamespaces, errorCircularReexport, errorInconsistentImportAssertions, errorInvalidFormatForTopLevelAwait, errorInvalidSourcemapForError, errorMissingExport, errorNamespaceConflict, errorParseError, errorShimmedExport, errorSyntheticNamedExportsNeedNamespaceExport, warnDeprecation } from './utils/error';
import { getId } from './utils/getId';
import { getOrCreate } from './utils/getOrCreate';
import { getOriginalLocation } from './utils/getOriginalLocation';
import { makeLegal } from './utils/identifierHelpers';
import { doAssertionsDiffer, getAssertionsFromImportExportDeclaration } from './utils/parseAssertions';
