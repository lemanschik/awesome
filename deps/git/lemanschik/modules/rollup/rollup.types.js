...
// utils
/** @typedef {null | undefined | void} NullValue */
/** @typedef {<T> | <T>[]} MaybeArray<T> */
/** @typedef {T | Promise<T>} MaybePromise<T> */ 
/** @typedef {{ [P in keyof T]: T[P] | null; }} PartialNull<T> */
/** @typedef {{ name?: string; stack?: string; watchFiles?: string[]; } & RollupLog} RollupError */ 
/** @typedef {RollupLog} RollupWarning */ 
/** @typedef {{binding?: string; cause?: Error; code?: string; exporter?: string; frame?: string; hook?: string; id?: string; ids?: string[]; loc?: { column: number; file?: string; line: number;	}; message: string; names?: string[]; plugin?: string; pluginCode?: string; pos?: number; reexporter?: string; stack?: string; url?: string;}} RollupLog */
/** @typedef {[number] | [number, number, number, number] | [number, number, number, number, number]} SourceMapSegment */
...
// TODO: This does not cover deprecated info need to create a better wrapper this is quick and dirty.
/** @typedef {{ acorn?: Record<string, unknown>; acornInjectPlugins?: (() => unknown)[] | (() => unknown); cache?: false | RollupCache; context?: string; experimentalCacheExpiry?: number; external?: ExternalOption; inlineDynamicImports?: boolean; input?: InputOption; makeAbsoluteExternalsRelative?: boolean | 'ifRelativeSource'; manualChunks?: ManualChunksOption; maxParallelFileOps?: number; maxParallelFileReads?: number; moduleContext?: ((id: string) => string | NullValue) | { [id: string]: string }; onwarn?: WarningHandlerWithDefault; perf?: boolean; plugins?: InputPluginOption; preserveEntrySignatures?: PreserveEntrySignaturesOption; preserveModules?: boolean; preserveSymlinks?: boolean; shimMissingExports?: boolean; strictDeprecations?: boolean; treeshake?: boolean | TreeshakingPreset | TreeshakingOptions; watch?: WatcherOptions | false; }} InputOptions */
/** @typedef {{	plugins: Plugin[]; } & InputOptions} InputOptionsWithPlugins*/
/** @typedef { acorn: Record<string, unknown>; acornInjectPlugins: (() => unknown)[]; cache: false | undefined | RollupCache; context: string; experimentalCacheExpiry: number; external: IsExternal; inlineDynamicImports: boolean | undefined; input: string[] | { [entryAlias: string]: string }; makeAbsoluteExternalsRelative: boolean | 'ifRelativeSource'; manualChunks: ManualChunksOption | undefined; maxParallelFileOps: number; maxParallelFileReads: number; moduleContext: (id: string) => string; onwarn: WarningHandler; perf: boolean; plugins: Plugin[]; preserveEntrySignatures: PreserveEntrySignaturesOption; preserveModules: boolean | undefined; preserveSymlinks: boolean; shimMissingExports: boolean; strictDeprecations: boolean; treeshake: false | NormalizedTreeshakingOptions;} NormalizedInputOptions */  
...
/** @typedef {{ output?: OutputOptions | OutputOptions[]; } & InputOptions} rollupOptions */
const RollupOptions = (/** @type {rollupOptions}} */ opt) => /** @type {rollupOptions}} */ (opt);


/** @typedef {{ output: OutputOptions[]; } & InputOptionsWithPlugins} MergedRollupOptions */
/** @typedef {(rollupCliOptions: import('./rollup').RollupOptions|import('./rollup').RollupOptions[]) => Promise<RollupBuild>} RollupCli */

// /** @type {(o:any)=> RollupCli} */
// export const rollupCli = (fn) =>  fn;
...
/** @typedef {{ end: number; start: number; type: string;}} AcornNode */


// Note: @deprecate the RollupOptions single option option 
// Makes programatical no sense. Simply only accept array thats it.
 ...
 * @param {rollupOptions|rollupOptions[]} options
 */
export const defineConfig = (/** @type {rollupOptions|rollupOptions[]} */ options) => /** @type {rollupOptions[]} */ ([].concat(options));
